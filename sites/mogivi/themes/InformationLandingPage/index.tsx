...
interface InformationLandingPage extends IDeviceDetected {
  block: any;
}

const InformationLandingPage = (props: InformationLandingPage) => {
  const { block } = props;
  const Component =
...
export default InformationLandingPage;
